...
export const UserContextProvider=({children})=>{
    ...
    return <UserContext.Provider value={{user,setUser,setisAuth,isAuth,loginUser,btnLoading,loading,registerUser,verifyOtp,fetchUser}}>{children}<Toaster/></UserContext.Provider>
}
